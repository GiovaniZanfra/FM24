...
def get_best_from_json(json_path, club, formation, players_to_remove=[], age_constraint=None, national_team=False):
...
def get_players_for_position(json_path, club, formation, national_team=False):
    with open(json_path, 'r') as f:
        json_data = json.load(f)
